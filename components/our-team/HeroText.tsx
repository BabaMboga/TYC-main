const HeroText = () => {
    return (
        <div className="flex flex-col gap-4 px-3 md:px-14 py-10 bg-[#19251D] text-slaye-50">
            <div className="items-center md:px-12">
                <p className="font-semibold text-center text-color-white text-xl md:px-2">
                    Meet Our Dedicated Team.
                </p>
            </div>

            <div className="flex items-center md:px-12">
                <p className="text-xl font-normal text-color-white text-center md:px-2">
