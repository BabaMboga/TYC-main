  ...
  return (
    <div className="flex  flex-col items-center gap-5 px-3 md:px-14 py-10 bg-[#19251D] text-slate-50">
      ...
      <div className="flex items-center md:px-12">
        <p className="text-2xl font-normal text-center md:px-2">
      ...
      <div className=" flex flex-col  items-center md:px-12 w-11/12">
        <ul className="list-outside list-disc ">
          <li>
          <p className="text-2xl font-normal py-2 md:px-2">
          ...
          <li>
          <p className="text-2xl font-normal  py-3 md:px-2">
          ...
          <li>
          <p className="text-2xl font-normal  md:px-2">
