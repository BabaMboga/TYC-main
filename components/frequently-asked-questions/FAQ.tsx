        ...
        <>
            <div className="space-y-4">
                ...
                >
                    <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                        <h2 className="text-lg font-medium text-gray-900">
                            How does TYC AFRICA TRUST support youth development?
                        </h2>
                    ...
                    <p className="mt-4 leading-relaxed text-gray-700">
                        TYC supports youth development through a variety of comprehensive programs and 
                        initiatives aimed at empowering young people and enhancing their personal and 
                        professional growth via ways such as mentorship programs, educational workshops, 
                        community engagement, career development, mental health support, networking opportunities 
                        among others.
                    </p>
                </details>
                ...
                >
                    ...
                    <p className="mt-4 leading-relaxed text-gray-700">
                        Visit the donate page on our website to access our various ways in which one can donate to our cause.
                    </p>
                </details>
                ...
                >
                    <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                        <h2 className="text-lg font-medium text-gray-900">
                            What type of events does TYC AFRICA TRUST host?
                        </h2>
                    ...
                    <p className="mt-4 leading-relaxed text-gray-700">
                        We host workshops, seminars, webinars, conferences and community events such 
                        as Love Visits focused on personal development, career skills, mental health 
                ...
                >
                    <summary className="flex cursor-pointer items-center justify-between gap-1.5">
                        <h2 className="text-lg font-medium text-gray-900">
                            Can I bring a friend to your events?
                        </h2>
                    ...
                    <p className="mt-4 leading-relaxed text-gray-700">
                        Yes, you are welcomed to bring friends to our events. Some events may require 
                        registration, so please check the event details.
                    </p>
                </details>
